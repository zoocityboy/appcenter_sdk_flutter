...
package zoo.cityboy.appcenter_sdk.distribute
...
enum class UpdateActionTap(val raw: Int) {
  POSTPONE(0),
  UPDATE(1);

  companion object {
    fun ofRaw(raw: Int): UpdateActionTap? {
...
interface DistributeApi {
  ...
  fun notifyDistributeUpdateAction(updateAction: UpdateActionTap, callback: (Result<Unit>) -> Unit)
  fun handleDistributeUpdateAction(updateAction: UpdateActionTap, callback: (Result<Unit>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: DistributeApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.setDistributeEnabled", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.notifyDistributeUpdateAction", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val updateActionArg = UpdateActionTap.ofRaw(args[0] as Int)!!
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.handleDistributeUpdateAction", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val updateActionArg = UpdateActionTap.ofRaw(args[0] as Int)!!
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.setDistributeDebugEnabled", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val enabledArg = args[0] as Boolean
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.isDistributeEnabled", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.disableAutomaticCheckForUpdate", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.checkForUpdates", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter_sdk.DistributeApi.ifExistsReleaseDetails", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
