...
package zoo.cityboy.appcenter.crashes
...
interface CrashesApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: CrashesApi?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter.CrashesApi.generateTestCrash", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter.CrashesApi.hasReceivedMemoryWarningInLastSession", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter.CrashesApi.hasCrashedInLastSession", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter.CrashesApi.crashesSetEnabled", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter.CrashesApi.crashesIsEnabled", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.appcenter.CrashesApi.trackException", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
