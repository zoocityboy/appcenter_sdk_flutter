...
class Analytics {
  ...
  static Future<void> trackEvent({
    ...
    final int? flags,
      ...
      AppCenterAnalyticsPlatformInterface.instance.trackEvent(name: name, properties: properties, flags: flags);

  /// Pauses log transmission.
  ///
  /// This API cannot be used if the service is disabled.
  static Future<void> pause() => AppCenterAnalyticsPlatformInterface.instance.pause();

  /// Resumes log transmission if paused.
  ///
  /// This API cannot be used if the service is disabled.
  static Future<void> resume() => AppCenterAnalyticsPlatformInterface.instance.resume();

  /// Enable Analytics service.
  static Future<void> enable() => AppCenterAnalyticsPlatformInterface.instance.enable();

  /// Disable Analytics service.
  static Future<void> disable() => AppCenterAnalyticsPlatformInterface.instance.disable();

  /// Check whether Analytics service is enabled or not.
  static Future<bool> isEnabled() => AppCenterAnalyticsPlatformInterface.instance.isEnabled();
  ...
  /// nothing.
  static Future<void> startSession() => AppCenterAnalyticsPlatformInterface.instance.startSession();
  ...
  static Future<bool> setTransmissionInterval(final int seconds) =>
      AppCenterAnalyticsPlatformInterface.instance.setTransmissionInterval(seconds);
}
