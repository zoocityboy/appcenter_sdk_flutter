...
class CrashesApi {
  ...
  Future<void> generateTestCrash() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.appcenter.CrashesApi.generateTestCrash', codec,
  ...
  Future<bool> hasReceivedMemoryWarningInLastSession() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.appcenter.CrashesApi.hasReceivedMemoryWarningInLastSession', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> hasCrashedInLastSession() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.appcenter.CrashesApi.hasCrashedInLastSession', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<void> crashesSetEnabled(bool arg_enabled) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.appcenter.CrashesApi.crashesSetEnabled', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
  ...
  Future<bool> crashesIsEnabled() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.appcenter.CrashesApi.crashesIsEnabled', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<void> trackException(String arg_message, String? arg_type, String? arg_stackTrace, Map<String?, String?>? arg_properties) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.appcenter.CrashesApi.trackException', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
