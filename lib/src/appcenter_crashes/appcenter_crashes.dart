...
class AppCenterCrashes {
  ...
  static Future<void> generateTestCrash() => AppCenterCrashesPlatformInterface.instance.generateTestCrash();

  /// Check whether there was a memory warning in the last session.
  static Future<bool> hasReceivedMemoryWarningInLastSession() =>
      AppCenterCrashesPlatformInterface.instance.hasReceivedMemoryWarningInLastSession();

  /// Check whether the app crashed in its last session.
  static Future<bool> hasCrashedInLastSession() => AppCenterCrashesPlatformInterface.instance.hasCrashedInLastSession();

  /// Enable Crashes service.
  static Future<void> enable() => AppCenterCrashesPlatformInterface.instance.enable();

  /// Disable Crashes service.
  static Future<void> disable() => AppCenterCrashesPlatformInterface.instance.disable();

  /// Check whether Crashes service is enabled or not.
  static Future<bool> isEnabled() => AppCenterCrashesPlatformInterface.instance.isEnabled();
