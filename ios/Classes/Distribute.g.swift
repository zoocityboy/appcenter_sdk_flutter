...
class DistributeApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: DistributeApi?) {
    let setDistributeEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.setDistributeEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let notifyDistributeUpdateActionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.notifyDistributeUpdateAction", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let handleDistributeUpdateActionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.handleDistributeUpdateAction", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setDistributeDebugEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.setDistributeDebugEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let isDistributeEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.isDistributeEnabled", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let disableAutomaticCheckForUpdateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.disableAutomaticCheckForUpdate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let checkForUpdatesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.checkForUpdates", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let ifExistsReleaseDetailsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.DistributeApi.ifExistsReleaseDetails", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
