...
class CrashesApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: CrashesApi?) {
    let generateTestCrashChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.CrashesApi.generateTestCrash", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let hasReceivedMemoryWarningInLastSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.CrashesApi.hasReceivedMemoryWarningInLastSession", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let hasCrashedInLastSessionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.CrashesApi.hasCrashedInLastSession", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let crashesSetEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.CrashesApi.crashesSetEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let crashesIsEnabledChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.CrashesApi.crashesIsEnabled", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let trackExceptionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.appcenter.CrashesApi.trackException", binaryMessenger: binaryMessenger)
    if let api = api {
