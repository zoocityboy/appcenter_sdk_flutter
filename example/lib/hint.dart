...
///   final textAttachment = Object.fromIntList(
///     utf8.encode(text),
///     'event_info.txt',
...
class Hint {
  ...
  factory Hint.withAttachment(Object attachment) {
    final hint = Hint();
    hint.attachments.add(attachment);
    return hint;
  }

  factory Hint.withAttachments(List<Object> attachments) {
    final hint = Hint();
  ...
  factory Hint.withScreenshot(Object screenshot) {
    final hint = Hint();
    hint.screenshot = screenshot;
    return hint;
  }

  factory Hint.withViewHierarchy(Object viewHierarchy) {
    final hint = Hint();
