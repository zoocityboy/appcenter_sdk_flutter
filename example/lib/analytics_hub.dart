import 'package:appcenter_example/utils.dart';
import 'package:flutter/foundation.dart';

import 'analytis_level.dart';
import 'hint.dart';

abstract class Hub {
  Future<void> addBreadcrumb(Breadcrumb crumb, {Hint? hint});
}

class AnalyticsHubAdapter extends Hub {
  @override
...
class Breadcrumb {
  ...
  Breadcrumb({
    ...
    this.type,
        ...
        level = level ?? AnalyticsLevel.info;
  ...
  factory Breadcrumb.fromJson(Map<String, dynamic> json) {
    ...
    return Breadcrumb(
      ...
      data: data,
      level: levelName != null ? AnalyticsLevel.fromName(levelName) : null,
      type: json['type'],
    );
  }
